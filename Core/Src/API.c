...
{
	uint8_t i = 0;
	int figure_ram_x[nr_pointsgiven]; // Array where the loop can easy find the x coordinates
	int figure_ram_y[nr_pointsgiven]; // Array where the loop can easy find the y coordinates
	va_list argumenten;
